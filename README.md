...
* Correction de l'API des annonces : requêtes paramétrées, pagination, limite des résultats et suppression du N+1.
* Correction du webhook de paiement : réponse rapide, gestion des erreurs et découplage des traitements secondaires.
* Création du client CRM avec timeout, retries, backoff exponentiel, gestion du `Retry-After` et clé d'idempotence.
